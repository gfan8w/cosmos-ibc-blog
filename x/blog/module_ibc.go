...
func (im IBCModule) OnRecvPacket(
	...
	case *types.BlogPacketData_UpdatePostPacket:
		packetAck, err := im.keeper.OnRecvUpdatePostPacket(ctx, modulePacket, *packet.UpdatePostPacket)
		if err != nil {
			ack = channeltypes.NewErrorAcknowledgement(err)
		} else {
			// Encode packet acknowledgment
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	case *types.BlogPacketData_UpdatePostPacket:
		err := im.keeper.OnAcknowledgementUpdatePostPacket(ctx, modulePacket, *packet.UpdatePostPacket, ack)
		if err != nil {
			return err
		}
...
func (im IBCModule) OnTimeoutPacket(
	...
	case *types.BlogPacketData_UpdatePostPacket:
		err := im.keeper.OnTimeoutUpdatePostPacket(ctx, modulePacket, *packet.UpdatePostPacket)
		if err != nil {
			return err
		}
