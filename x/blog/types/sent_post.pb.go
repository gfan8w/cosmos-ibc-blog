...
func (m *SentPost) GetCreatorNoMessage() string {
	if m != nil {
...
var fileDescriptor_c61cffbf1305fe72 = []byte{
	...
	,
}
...
func (m *SentPost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CreatorNoMessage) > 0 {
		...
		i = encodeVarintSentPost(dAtA, i, uint64(len(m.CreatorNoMessage)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Chain) > 0 {
